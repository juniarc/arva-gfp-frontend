  ...
  return (
    <main className="py-5 px-10 tablet:p-15 min-h-[90vh]">
      <div className="w-full flex justify-between gap-5">
        <div className=" w-full h-15 tablet:h-30 animate-pulse rounded bg-gray"></div>
        <div className="flex gap-5">
          <div className="h-15 w-15 tablet:h-30 tablet:w-30 rounded tablet:rounded-lganimate-pulse bg-gray"></div>
          <div className="h-15 w-15 tablet:h-30 tablet:w-30 rounded tablet:rounded-lg animate-pulse bg-gray"></div>
        </div>
      </div>
