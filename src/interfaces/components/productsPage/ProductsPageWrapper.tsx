...
export default function ProductsPageWrapper({ products, viewport }: ProductsPageWrapperProps) {
  ...
  if (viewport === "mobile") return <ProductsPage products={filteredProducts} handleFilterBtn={handleFilterBtn} />;
