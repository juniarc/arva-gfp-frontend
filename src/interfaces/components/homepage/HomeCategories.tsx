  ...
  return (
    <div className="tes w-auto bg-white p-5 tablet:p-10 rounded-lg shadow-lg mx-10">
      <div className="w-full grid grid-cols-5 gap-7 items-center justify-center">
        <Link href="/products/seeds" className="flex flex-col items-center justify-center gap-3 bg-secondary rounded p-5 tablet:min-h-[120px]">
          <CiCoffeeBean className="text-xl tablet:text-[2.5rem]" />
          <span className="text-[0.5rem] tablet:text-base">Seeds</span>
        </Link>
        <Link href="/products/vegetables" className="flex flex-col  items-center justify-center gap-3 bg-secondary rounded p-5 tablet:min-h-[120px]">
        ...
        <Link href="/products/fruits" className="flex flex-col  items-center justify-center gap-3 bg-secondary rounded p-5 tablet:min-h-[120px] ">
        ...
        <Link href="/products/fertilizers" className="flex flex-col  items-center justify-center gap-3 bg-secondary rounded p-5 tablet:min-h-[120px]">
        ...
        <Link href="/products/equipments" className="flex flex-col items-center justify-center gap-3 bg-secondary rounded p-5 tablet:min-h-[120px]">
