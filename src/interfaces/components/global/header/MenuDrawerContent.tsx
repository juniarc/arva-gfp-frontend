    ...
    <div className="w-full py-5 tablet:py-10 px-10">
      <div>
        ...
        <div className="flex flex-col gap-8 items-start">
          ...
          <Link href="/products/vegetables" className="flex items-center gap-8">
            <Image src={SpinachIcon} className="w-10 h-10 tablet:w-15 tablet:h-15" alt="Spinach Icon" />
            <p>Vegetables</p>
          </Link>
          <Link href="/products/fruits" className="flex items-center gap-8">
            <Image src={FruitsIcon} className="w-10 h-10 tablet:w-15 tablet:h-15" alt="Spinach Icon" />
            <p>Fruits</p>
          </Link>
          <Link href="/products/fertilizers" className="flex items-center gap-8">
            <Image src={FertilizersIcon} className="w-10 h-10 tablet:w-15 tablet:h-15" alt="Spinach Icon" />
            <p>Fertilizers</p>
          </Link>
          <Link href="/products/equipments" className="flex items-center gap-8">
        ...
        <LineDivider className="my-10" />
        <Link href="/login" className="flex items-center gap-8">
